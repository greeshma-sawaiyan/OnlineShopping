<%-- 
    ...
    Created on : May 23, 2020, 8:32:09 PM
    Author     : parth
--%>
    ...
    try
       {
        ...
        Connection con1 =DriverManager.getConnection("jdbc:mysql://localhost:3306/onlineshopping","root","password");
            HttpSession se=request.getSession();          
            String email=(String)se.getAttribute("user_email"); 
            PreparedStatement pst=con1.prepareStatement("select name ,item,deliver,feedback ,item_id from purchase where email='"+email+"'");
